...
pub fn get_default_settings() -> AppSettings {
    ...
    #[cfg(target_os = "windows")]
    let default_lock_shortcut = "ctrl+shift+l";
    #[cfg(target_os = "macos")]
    let default_lock_shortcut = "command+shift+l";
    #[cfg(target_os = "linux")]
    let default_lock_shortcut = "ctrl+shift+l";
    #[cfg(not(any(target_os = "windows", target_os = "macos", target_os = "linux")))]
    let default_lock_shortcut = "ctrl+shift+l";
    ...
    bindings.insert(
        ...
        ShortcutBinding {
            id: "lock_handy".to_string(),
            name: "Pin & click through".to_string(),
            description: "Dim Handy and let clicks pass through so you can keep working while it runs."
                .to_string(),
