...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::open_investigation_window,
            commands::open_investigation_vault_window,
            commands::get_investigation_session,
            commands::save_investigation_session,
            commands::clear_investigation_session,
            commands::record_investigation_actor,
            commands::get_handy_locked,
            commands::toggle_handy_lock,
