 ...
 */
async openInvestigationWindow() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_investigation_window") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async openInvestigationVaultWindow() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_investigation_vault_window") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getInvestigationSession() : Promise<InvestigationSession | null> {
    return await TAURI_INVOKE("get_investigation_session");
},
async saveInvestigationSession(session: InvestigationSession) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("save_investigation_session", { session }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async clearInvestigationSession() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("clear_investigation_session") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async recordInvestigationActor(actor: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("record_investigation_actor", { actor }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getHandyLocked() : Promise<boolean> {
    return await TAURI_INVOKE("get_handy_locked");
},
/**
 * Toggle pin / click-through mode (same as the lock_handy shortcut).
 */
async toggleHandyLock() : Promise<boolean> {
    return await TAURI_INVOKE("toggle_handy_lock");
},
...
export type InvestigationSession = { id: string; title: string; 
/**
 * JSON-encoded `ProvenanceEntry[]` from the TS browser layer.
 */
entries_json: string; created_at_ms: number; 
/**
